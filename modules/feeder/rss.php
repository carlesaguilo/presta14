...
// Get data
$number = ((int)(Tools::getValue('n')) ? (int)(Tools::getValue('n')) : 20);
$orderBy = Tools::getProductsOrder('by', Tools::getValue('orderby'));
$orderWay = Tools::getProductsOrder('way', Tools::getValue('orderway'));
$id_category = ((int)(Tools::getValue('id_category')) ? (int)(Tools::getValue('id_category')) : 45);
$products = Product::getProducts((int)($cookie->id_lang), 0, ($number > 20 ? 20 : $number), $orderBy, $orderWay, $id_category, true);
