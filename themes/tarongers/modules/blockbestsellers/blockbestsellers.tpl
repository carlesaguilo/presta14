...
<div id="blockbestsellers" class="block products_block">
	...
	<ul>
		...
		{if $smarty.foreach.myLoop.iteration <= 5}
	...
	<a href="{$link->getPageLink('best-sales.php')}" title="{l s='All best sellers' mod='blockbestsellers'}" class="button_large">{l s='All best sellers' mod='blockbestsellers'}</a>
	{else}
